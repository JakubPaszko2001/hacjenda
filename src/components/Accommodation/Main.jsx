    ...
    <div class='w-screen'>
      <div class='flex flex-col w-4/5 m-auto font-regular mt-10 mb-10 lg:flex-row'>
        <div class='flex flex-col justify-center bg-darkgreen p-4 lg:w-1/2'>
          ...
          <h1 data-aos="fade-up" data-aos-duration="2000" class='text-gold lg:text-xl'>Zapraszamy do korzystania z naszego pensjonatu znajdującego się na terenie malowniczej wsi Jasionówka. Zaledwie 30 km od Białegostoku. Na naszym terenie znajduję się 5 hektarowy ogród, zarybiony staw z możliwością wędkowania, altany oraz miejsce do grillowania i na ognisko. Zapewniamy, cieszę i spokój daleko od zgiełku miasta, otoczeni zielenią w przyjemnej i miłej atmosferze. Pokoje, które proponujemy naszym gościom, zostały starannie przygotowane i wyposażone we wszelkie niezbędne udogodnienia, takie jak telewizor z płaskim ekranem, lodówką oraz łazienkę z prysznicem. Do dyspozycji gości jest mini bar, przytulny kominek oraz część wypoczynkowa wraz z bufetem.</h1>
        ...
        <div class='flex flex-col lg:flex-row'>
          ...
          <div class='flex bg justify-center items-center w-full h-10 lg:flex-col lg:h-full'>
            <div onClick={() => {setRoom(pokoj)}} class='w-5 h-5 lg:ml-4 lg:mr-4 mr-2 lg:mr-[-2] lg:mb-2 rounded-full bg-gold cursor-pointer' id='1'></div>
            <div onClick={() => {setRoom(pokoj1)}} class='w-5 h-5 lg:ml-4 lg:mr-4 rounded-full bg-gold cursor-pointer' id='2'></div>
