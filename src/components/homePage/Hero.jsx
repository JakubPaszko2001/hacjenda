    ...
    <div class='h-96 w-screen bg-white lg:h-[40rem]'>
        <div class='flex w-10/12 h-[40rem] bg-white z-20 translate-y-[-50%]'>
          ...
          <div class='w-5/6 bg-darkgreen responsive'>
            <div class='h-1/2 p-2 text-gold font-regular lg:p-10 sm:text-xl sm:pr-16 sm:pl-16 lg:w-1/2 lg:flex lg:justify-center lg:items-center lg:m-auto'>
            ...
            <div class='h-1/2 w-3/4 right-0 absolute lg:h-4/5'>
              <div class='h-[110%] bg-cover bg-center pl-2 lg:w' style={{backgroundImage: `url(${wesele})`}}></div>
            </div>
          </div>
        </div>
    </div>
